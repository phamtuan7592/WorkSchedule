...
import com.example.workschedule.Components.filterSchedules
...
fun Search(navController: NavHostController) {
    ...
    val allSchedules by viewModel.schedule.collectAsState()

    val filteredSchedules = remember(search.text, allSchedules) {
        filterSchedules(search.text, allSchedules)
    }
        ...
        LazyColumn(
            ...
            item {
                Column(
                    ...
                    filteredSchedules.forEach { task ->
                        TaskItemInteractive(
                            item = task,
            ...
            if (filteredSchedules.isEmpty() && search.text.isNotBlank()) {
                item {
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
